...
/* harmony import */ var _components_script_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/script.js */ "./src/js/components/script.js");
/* harmony import */ var _components_header_onscroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/header-onscroll.js */ "./src/js/components/header-onscroll.js");
...
/* harmony import */ var _components_gallery_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/gallery.js */ "./src/js/components/gallery.js");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.addEventListener("resize", event => {
    const openedAcoordions = document.querySelectorAll(".accordion--open");
...
/***/ "./src/js/components/header-onscroll.js":
/*!**********************************************!*\
  !*** ./src/js/components/header-onscroll.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
const brandsButton = document.querySelector(".nav__link");
// console.log(brandsButton);
const brandList = document.querySelector(".brand-nav__list");
...
if (hasTouchScreen()) {
  brandsButton.addEventListener("click", e => {
    e.preventDefault();
    e.stopPropagation();
    brandList.classList.toggle("brand-nav__list--active");
    window.addEventListener("click", () => {
      brandList.classList.remove("brand-nav__list--active");
    });
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.FreeMode]);
window.addEventListener("DOMContentLoaded", () => {
  ...
  resizableSwiper("", ".story__slider", SwiperStory, someFunc);
});

// let menu = ["Slide 1", "Slide 2", "Slide 3", "Slide 4", "Slide 5", "Slide 6"];
...
let SwiperStory = {
  ...
  pagination: {
    ...
    clickable: true,
    dynamicBullets: true,
    bulletClass: "story-slider__bullet",
    bulletActiveClass: "story-slider__bullet--active",
    // dynamicMainBullets: 1,
    renderBullet: function (index, className) {
      // return '<span class="' + className + '">' + (2016 + index) + "</span>";
      return '<div class="' + className + '"><span>' + (2016 + index) + "</span></div>";
    }
    // renderCustom: function (swiper, current, total) {
    //   return '<span class="' + current + '">' + (2016 + current) + "</span>";
    //   // return '<div class="story-slider__bullet">' + (2015 + current - 1) + "</div>" + '<div class="story-slider__bullet">' + (2015 + current) + "</div>" + '<div class="story-slider__bullet">' + (2015 + current + 1) + "</div>";
    // },
  }
};
...
function setupVideo(video) {
  ...
  let image = document.querySelector(".video__image");
